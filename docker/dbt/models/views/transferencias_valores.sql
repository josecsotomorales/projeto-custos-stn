select
	...
	sum(valor_custo_de_transferencias) as valor_custo_total,
	min(valor_custo_de_transferencias) as valor_custo_minimo,
	max(valor_custo_de_transferencias) as valor_custo_maximo,
	calendario.id,
...
inner join {{ ref('dim_calendario') }} calendario on calendario.mes_ano = fato_transferencias.mes_ano_lancamento 
